...
public class YueWifiHelper {
    ...
    public void filterAndConnectTargetWifi2(ScanResult mScanResult, String targetWifiName, boolean isLastTime) {
        WifiUtil.filterAndConnectTargetWifi2(mContext.get(), delegate, mScanResult, targetWifiName, isLastTime, listener);
    }
